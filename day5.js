const fs = require("fs");
let array = fs
    .readFileSync("C:\\JavaScript\\Advencode\\measurements5.txt", "utf8")
    .split("\r\n");
...
let coordinates1=array.filter(item=>
...
array.forEach(coordiante=>{
    ...
    if(coordiante.x1===coordiante.x2){
        let startPoint=coordiante.y1>coordiante.y2 ? coordiante.y2:coordiante.y1;
        ...
        let startPoint=coordiante.x1>coordiante.x2 ? coordiante.x2:coordiante.x1;
        ...
        let startPoint=coordiante.y1>coordiante.y2 ? {x:coordiante.x2,y:coordiante.y2}:{x:coordiante.x1,y:coordiante.y1};
        let endPoint=startPoint.y===coordiante.y1?{x:coordiante.x2,y:coordiante.y2}:{x:coordiante.x1,y:coordiante.y1};
